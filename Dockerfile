...
# Use production environment for Docker builds
...
# Clear any existing databases and initialize a fresh database
# Using the non-interactive docker_clean_databases.py script instead of the interactive clean_all_databases.py
RUN python docker_clean_databases.py && \
